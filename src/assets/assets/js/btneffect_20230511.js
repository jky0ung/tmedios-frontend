...
function fbtndisableFalse(e) {
    ...
    if(e == 1) {
        ...
        $(".select_re_btn, .select_to_btn").css({"opacity": "0.5"});
        $(".select_re_btn, .select_to_btn").attr("disabled", true); 
...
function fbtndisableTrue(e) {
    ...
    if(e == 1) {
        ...
        $(".select_re_btn, .select_to_btn").css({"opacity": "1"});
        $(".select_re_btn, .select_to_btn").attr("disabled", false); 
    } else if(e == 6) {  // accept_today_select.html
